...
public class AStarTest {
	...
	@Test
	public void testAStarUndirected() throws GraphBuildException, FileNotFoundException, WrongFileTypeException, AccessException {
	...
	@Test
	public void testAStarDirected() throws GraphBuildException, FileNotFoundException, WrongFileTypeException, AccessException{
		...
		assertEquals(am.startAStar(start1, target).getPathLength(), 31);
		assertEquals(am.startAStar(start2, target).getPathLength(), 0);
		assertEquals(am.startAStar(start3, target).getPathLength(), 13);
