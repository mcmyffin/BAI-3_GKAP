...
public class HierholzerTest {
	...
	@Test
	public void testHierholzerSimple() throws FileNotFoundException, WrongFileTypeException, AccessException, GraphBuildException{
		...
		for(String aStartNode : startNodes){
			...
			Fleury_Hierholzer_Report reporter = (Fleury_Hierholzer_Report) gmanager.startHierholzer(aStartNode);
